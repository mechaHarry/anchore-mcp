...
def test_sdist_contains_only_allowlisted_distribution_files(tmp_path: Path) -> None:
    ...
    assert members == {
        ...
        "src/anchore_mcp/domain/handoff.py",
        "src/anchore_mcp/domain/images.py",
        "src/anchore_mcp/domain/policy.py",
        "src/anchore_mcp/domain/policy_report.py",
        "src/anchore_mcp/domain/resolution.py",
        "src/anchore_mcp/domain/selection.py",
        "src/anchore_mcp/domain/vulnerabilities.py",
